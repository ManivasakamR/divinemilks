<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GnNotifications.aspx.cs" Inherits="Default2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">     
     <div  id="DivGnNot" class="jumbotron" style="margin-left:2%; margin-right:2%;">                               
         <asp:Label ID="Label2" runat="server" Style="margin-left:30%;font-size:24px;" Text="Generate Notification" CssClass="text-primary"></asp:Label>        <br />
                <asp:Label ID="Label1" runat="server" Style="font-size:20px;" Text="User Id" CssClass="text-primary"></asp:Label>
