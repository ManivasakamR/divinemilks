...
{    
    ...
    public void getHead()
    {
        divTblPurDtl.Controls.Add(new LiteralControl("<h4 style='margin-top:2%; margin-left:39%; padding-bottom:10px; color:#e0e0e0 !important' class='text-primary'>Payment details</h4>"));
        //
        divTblPurDtl.Controls.Add(new LiteralControl("<table style='margin-top:8px; margin-bottom:8px;'>"));
        divTblPurDtl.Controls.Add(new LiteralControl("<tr><th>Id</th><th>User Id</th><th>Date</th><th>Morning</th><th>Evening</th><th>Pay Mode</th></tr>"));
    }
    public void getftr()
    {
    ...
    public void getDetails()
    {
        ...
        SqlCommand cmd = new SqlCommand("select Var_Purdtl_PrId,Var_Purdtl_UId,Dt_Purdtl_Date,Flt_Purdtl_Morning,Flt_Purdtl_Evening from Tbl_Purchase_Details where Var_Purdtl_PayFlag='P'  order by Var_Purdtl_UId", DBContext._SqlConnection);
        ...
        while (dr.Read())
        {
            ...
            divTblPurDtl.Controls.Add(new LiteralControl("<td>" + "SBI Pay" + "</td>"));
            divTblPurDtl.Controls.Add(new LiteralControl("</tr>"));
        }
        if (i == 0)
        {
